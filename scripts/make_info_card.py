...
# ===========================================================================
HOST = "ogharsh-2025"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "B.Tech CSE Student @ Babu Banarasi Das NIIT"),
    ("kv", "Prev", "Technology Virtual Intern"),
    ("kv", "Also", "AI & Web Dev Enthusiast"),
    ("kv", "Edu", "B.Tech in CSE, Babu Banarasi Das NIIT '27"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Java, Python, C, JavaScript, TypeScript"),
    ("kv", "Web Tech", "React.js, HTML5, CSS3, Tailwind CSS, MySQL"),
    ("kv", "AI / ML", "Agentic AI, Generative AI, Machine Learning"),
    ("kv", "Tools", "Git, GitHub, VS Code"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Smart India Hackathon 2024 National Participant"),
    ("bul", "Oracle Cloud Computing Certified (2025)"),
]
